...
DATA_PATH = '/Users/tkurfurst/Programming/Udacity/UdacityND101 (Deep Learning Foundations)/GitHub/deep-learning/seq2seq/stanfordchatbot/data/cornell movie-dialogs corpus'
...
# parameters for processing the dataset
DATA_PATH = '/home/carnd/deep-learning/seq2seq/stanfordchatbot/data/cornell movie-dialogs corpus'
CONVO_FILE = 'movie_conversations.txt'
LINE_FILE = 'movie_lines.txt'
OUTPUT_FILE = 'output_convo.txt'
PROCESSED_PATH = 'processed'
...
NUM_SAMPLES = 512
>>>>>>> 8bd11bfbd13e7e6df350b77bec17fbd3ae058a22
